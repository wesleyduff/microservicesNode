...
exports.post = (req, res) => {
    ...
    request(ingestEndpoint + zoneID, (error, response, body) => {
        ...
        if(response){
            ...
            req.databaseName.collection(ingestCollection)
...
exports.getAll = (req, res) => {
    ...
    req.databaseName.collection(ingestCollection).find({}, {} ).toArray(function(error, data) {
        if (error) {
            res.json({
                error
            })
...
exports.get = (req, res) => {
    const zoneID = req.params.dataID;
    req.databaseName.collection(ingestCollection).find({'_id': ObjectID(zoneID)}, {} ).toArray(function(error, data) {
        if (error) {
            res.json({
                error
            })
