const   fs      = require('fs'),
        ...
        serviceEndpoint = process.env.NODE_ENV === 'dev' ? 'http://testharness.com:8080' : process.env.NODE_ENV === undefined ? '/svc' : 'https://acd8088d091d611e8855502929adfc33-996456070.us-west-2.elb.amazonaws.com/';
